...
/****
        ...
        */
public class VBGetEventsRequest extends GsonRequest<VBGetEventsParser[]> {
    public VBGetEventsRequest(int venueID, Map<String, String> headers, Response.Listener<VBGetEventsParser[]> listener, Response.ErrorListener errorListener) {
        super(
